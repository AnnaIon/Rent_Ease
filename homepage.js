...
const userName = userNameGreet.innerText = loggedInUser.username; 

console.log(flatsList);

const mainCard =document.querySelector('main');
const cards =document.getElementById('favoriteList');

cards.classList.add('cards');
mainCard.appendChild(cards);


const filterArray = flatsList.filter(apartmentObj => apartmentObj.favorite ===true);
...
function add(dataArray){
    ...
    dataArray.forEach(element => {
        ...
        //    dataArray.favorite = true
        //    console.log(dataArray);

            // localStorage.setItem('loggedInUser',JSON.stringify(loggedInUser));
            // localStorage.setItem('registerUsers',JSON.stringify(loggedInUser));
    ...
    //     const selectedOption = document.getElementById('sortFilter');

    //     const data = JSON.parse(localStorage.getItem('allFlats'));
    //     const y = data? data : [];
    //     const filterArray = [];
    //     console.log(y);
    
    //     if(selectedOption.value === 'city'){
    //         y.forEach(e =>{
    //             console.log(e.city);
    //         })
    //        const filterArray = y.sort((a,b) => a.city.localeCompare(b.city));
